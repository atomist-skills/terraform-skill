...
export const Skill = skill({
    ...
    resourceProviders: {
      ...
      slack: slackResourceProvider({minRequired: 1}),
      gcp: gcpResourceProvider({
    ...
    parameters: {
        ...
        workspace: {
          description: "Name of Terraform workspace to use.  Workspace must already exist!",
        ...
        branch: {
          description: "Git branch for Terraform to operate on. " +
        ...
        envvars: {
          ...
          description: "Set Environment Variables that will be set when Terraform code runs.  Provide in the form of"
            + " name=value",
        ...
        cmdlinevars: {
          description: "Command line vars to be passed to Terraform.  Provide in the form name=value",
        ...
        varfiles: {
          required: false,
          type: ParameterType.StringArray,
          description: "Supply one or more Terraform variable files to be used when launching Terraform actions",
          displayName: "Terraform Variable Files",
        },
        init: {
          required: false,
          type: ParameterType.Boolean,
          description: "Should the skill not execute `terraform init` prior to running a plan/apply?",
        ...
        version: {
          ...
          type: ParameterType.String,
          placeHolder: "0.12.26",
          description: "Supply the version of Terraform to use for this configuration.",
